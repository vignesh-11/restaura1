...
plt.legend(loc="upper right")
plt.savefig("loc_rt_oo.png", bbox_inches="tight")
...
plt.legend(loc="upper right")
plt.savefig("loc_rt_tb.png", bbox_inches="tight")
...
plt.legend(loc="upper right")
plt.savefig("loc_c_oo.png", bbox_inches="tight")
...
ax.set_title(str(user_cuisine) + ' \nrestaurants that accept online table booking in \n' + str(user_location))
plt.legend(loc="upper right")
plt.savefig("loc_c_tb.png", bbox_inches="tight")
...
ax.set_title(str(user_rest_type) + ' \nrestaurants that accept online orders in \nBangalore')
plt.legend(loc="upper right")
plt.savefig("rt_oo.png", bbox_inches="tight")
...
plt.legend(loc="upper right")
plt.savefig("rt_tb.png", bbox_inches="tight")
...
ax.set_title(str(user_cuisine) + ' \nrestaurants that accept online orders in \nBangalore')
plt.legend(loc="upper right")
plt.savefig("c_oo.png", bbox_inches="tight")
...
ax.set_title(str(user_cuisine) + ' \nrestaurants that accept online table bookings in \nBangalore')
plt.legend(loc="upper right")
plt.savefig("c_tb.png", bbox_inches="tight")
...
pdf.cell(50)
pdf.image("loc_rt_oo.png", h=100)
pdf.ln()
pdf.cell(50)
pdf.image("loc_rt_tb.png", h=100)
pdf.ln(5)
...
pdf.cell(50)
pdf.image("loc_c_oo.png", h=100)
pdf.ln()
pdf.cell(50)
pdf.image("loc_c_tb.png", h=100)
pdf.ln(5)
...
pdf.cell(50)
pdf.image("rt_oo.png", h=100)
pdf.ln()
pdf.cell(50)
pdf.image("rt_tb.png", h=100)
pdf.ln(5)
...
pdf.cell(50)
pdf.image("c_oo.png", h=100)
pdf.ln()
pdf.cell(50)
pdf.image("c_tb.png", h=100)
pdf.ln(5)
...
pdf.cell(0, 10, '15. Success Probability : ' + str(succ) + "%", ln=1)
